...
class Settings:
    ...
    # Example: https://trader:***@52-78-134-200.nip.io (recommended via 443 reverse-proxy)
    ...
    # OKX trailing-stop refresh (periodically tightens SL algo order when in profit)
    okx_refresh_enabled: bool = _getenv_bool("OKX_REFRESH_ENABLED", True)
    okx_refresh_seconds: int = _getenv_int("OKX_REFRESH_SECONDS", 60)
