# DEVELOPING_GUIDE.md - V2 Event-Driven 开发指南
# perp-tools 开发指南（企业级 · AI 友好版）

**版本**: V2 (Event-Driven Architecture)  
**最后更新**: 2025-12-12  

本文件是 **perp-tools V2** 的官方开发规范，用于指导未来所有开发者（包括 AI 代理、未来你自己、外包工程师）在 **V2 事件驱动架构** 下进行扩展、维护与部署。

本开发指南遵循以下目标：

- 能让任何新开发者 **10 分钟内理解 V2 EventBus 星型架构**
- 清晰定义每个模块的 **事件订阅、发布、边界**
- 降低系统耦合度，让套利逻辑通过事件驱动保持简洁且高性能
